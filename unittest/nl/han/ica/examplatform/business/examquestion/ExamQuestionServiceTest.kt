...
class ExamQuestionServiceTest {
    ...
    fun testCheckQuestion() {
        val question = Question(questionId = 1, questionType = "OpenQuestion", questionPoints = 4, courseId = 1, examType = "Tentamen", answerType = "OpenQuestion", answerTypePluginVersion = "1.0", questionTypePluginVersion = "1.0", partialAnswers = arrayListOf())
    ...
    fun testAddQuestionToExam() {
        val expectedQuestion = Question(questionId = 0, questionOrderInExam = 1, questionType = "OpenQuestion", questionText = "name", questionPoints = 5, courseId = 1, examType = "Tentamen", answerType = "OpenQuestion", answerTypePluginVersion = "1.0", questionTypePluginVersion = "1.0", partialAnswers = arrayListOf())
