...
class ExamQuestionServiceTest {
    ...
    fun testCheckQuestion() {
        val question = Question(questionId = 1, questionType = "OpenQuestion", questionPoints = 4f, examType = "Tentamen", pluginVersion = "1.0")
    ...
    fun testAddQuestionToExam() {
        val expectedQuestion = Question(questionId = 0, questionOrderInExam = 1, questionType = "OpenQuestion", questionText = "name", questionPoints = 5F, examType = "Tentamen", pluginVersion = "1.0")
