...
internal class ExamServiceTest {
    ...
    fun testCheckExamEmptyQuestions() {
        val exam = Exam(null, "name-0", 10, Date(6000), courseId = 1, version = 1, examType = "Tentamen",
                questions = arrayListOf(Question(questionType = "OpenQuestion", questionPoints = 1, courseId = 1, examType = "Tentamen", answerType = "OpenQuestion", answerTypePluginVersion = "1.0", pluginVersion = "1.0"))) // Faulty exam object
        examService.checkExam(exam)
    }
