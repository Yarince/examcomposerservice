...
class ExamControllerTest {
    ...
    fun addQuestionToExam() {
        val expected = Exam(examId = 1, name = "name-0", durationInMinutes = 10, startTime = Date(6000), courseId = 1, version = 1, examType = "Tentamen", questions = arrayListOf(
                Question(questionId = 1, questionType = "OpenQuestion", questionPoints = 5, courseId = 1, examType = "Tentamen", answerType = "OpenQuestion", answerTypePluginVersion = "1.0", questionTypePluginVersion = "1.0", partialAnswers = arrayListOf())))
